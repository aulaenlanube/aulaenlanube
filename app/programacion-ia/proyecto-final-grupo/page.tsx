  ...
  return (
    <div className="mx-auto w-full max-w-5xl px-4 py-6">
      ...
      <h1 className="mt-3 text-3xl font-extrabold tracking-tight sm:text-4xl">
        Proyecto final en grupo: vuestra <em className="not-italic text-blue-700">startup</em>
      </h1>
      ...
      <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-3">
        <div className="rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm">
          ...
          <p className="mt-1 text-sm text-zinc-600">Quien diseña, quien organiza, quien prueba todo, quien habla con usuarios, quien no para de proponer. 4-5 cabezas <b>distintas</b> valen el doble que 5 iguales.</p>
        </div>
        <div className="rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm">
          <h3 className="text-[15px] font-bold">🔥 Misma ambición</h3>
          <p className="mt-1 text-sm text-zinc-600">Que haya hambre de producto vendible en todos. Mezclar ambiciosos con «solo quiero aprobar» rompe al equipo a la tercera semana. Los que queréis algo grande, os juntáis entre vosotros.</p>
        </div>
        <div className="rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm">
          <h3 className="text-[15px] font-bold">🤝 Confianza</h3>
          <p className="mt-1 text-sm text-zinc-600">Nos conoceremos antes de decidir: dinámicas en clase, proyectos pequeños previos. Elegid a quien cumple, no solo a quien cae bien — aunque la mejor combinación es quien cae bien Y cumple.</p>
        </div>
      </div>
      ...
      <div className="mt-4 overflow-x-auto rounded-2xl border border-zinc-200">
        <table className="w-full min-w-[640px] border-collapse text-sm">
          ...
          <tbody className="[&_tr]:border-t [&_tr]:border-zinc-200 [&_td]:px-3.5 [&_td]:py-2.5 [&_td]:align-top [&_td]:text-zinc-600">
            <tr>
              <td className="font-bold text-zinc-800">Reservas locales (pádel, aula de estudio, peluquería del pueblo)</td>
            ...
            <tr>
              <td className="font-bold text-zinc-800">Marketplace de segunda mano hiperlocal (material escolar, componentes)</td>
            ...
            <tr>
              <td className="font-bold text-zinc-800">SaaS para profes (pase de lista, generador de exámenes, control de proyectos)</td>
            ...
            <tr>
              <td className="font-bold text-zinc-800">Comunidad deportiva (rutas, récords, quedadas — tipo Strava local)</td>
            ...
            <tr>
              <td className="font-bold text-zinc-800">Micro-SaaS con IA (generador de algo útil para un nicho concreto)</td>
      ...
      <div className="mt-10 flex flex-wrap items-center justify-between gap-3 border-t border-zinc-200 pt-5">
        <Link href="/programacion-ia/proyecto-final-individual/" className="rounded-xl border border-zinc-300 bg-white px-5 py-2.5 text-sm font-semibold text-slate-700 transition hover:bg-zinc-50">
          ← Proyecto individual
        </Link>
        <Link href="/programacion-ia/" className="rounded-xl bg-slate-700 px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-slate-800">
          Volver al curso →
        </Link>
      </div>
    </div>
