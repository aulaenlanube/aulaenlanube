...
export default function CursoIAWebPersonal() {
  return (
    <div className="mx-auto w-full max-w-6xl px-4 py-6">
      ...
      <p className="mt-1 max-w-3xl text-[15px] text-zinc-600">
      ...
      <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-3">
        {CARDS.map(([f, t, d]) => (
          <div key={f} className="rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm">
            <h3 className="font-mono text-[15px] font-bold text-zinc-800">{f}</h3>
      ...
      <div className="mt-4 overflow-x-auto rounded-2xl border border-zinc-200">
        <table className="w-full min-w-[560px] border-collapse text-sm">
          ...
          <tbody>
            {FILAS.map(([b, q, r]) => (
              <tr key={b} className="border-t border-zinc-200 align-top">
                <td className="px-3.5 py-2.5 font-bold text-zinc-800">{b}</td>
                <td className="px-3.5 py-2.5 text-zinc-600">{q}</td>
                <td className="px-3.5 py-2.5 italic text-zinc-500">{r}</td>
              </tr>
            ))}
          </tbody>
        </table>
      ...
      <div className="mt-4 space-y-3">
        ...
        >
          <span className="font-extrabold text-zinc-400">01</span>
