...
export default function Movido() {
  ...
  useEffect(() => {
    router.replace("/adaptaciones-pte/2eso/matematicas/tema-1/04-suma-resta/");
  }, [router]);
  return (
    <div className="mx-auto w-full max-w-4xl px-4 py-16 text-center">
      ...
      <p className="mt-3 text-zinc-600">
        ...
        <a className="font-semibold text-blue-700 underline" href="/adaptaciones-pte/2eso/matematicas/tema-1/04-suma-resta/">mira el apartado completo aquí</a>.
      </p>
    </div>
  );
}
