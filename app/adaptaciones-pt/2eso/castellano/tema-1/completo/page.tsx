    ...
    <div className="mx-auto w-full max-w-[1100px] px-4 pb-16 pt-6 sm:px-6 lg:px-8">
      ...
      <header className="mt-6 border-b border-zinc-200 pb-6">
        <h1 className="text-3xl font-bold tracking-tight text-zinc-900">
          {TEMA} — <span className="text-blue-700">todo el tema</span>
        </h1>
      ...
      {APS.map((ap, i) => {
        ...
        return (
          <section key={ap.slug} className={i === 0 ? "mt-10" : "print-break mt-14"}>
            ...
            <div className="mt-4 rounded-2xl border border-blue-200 bg-blue-50/60 p-5 shadow-sm sm:p-7">
                ...
                <div className="mt-3 grid gap-4 lg:grid-cols-2">
                  {a.nv.map((nv, l) => (
                    <div key={l} className="rounded-xl border border-zinc-200 bg-zinc-50 p-4">
                      ...
                      {nv.in ? <p className="mt-1 text-sm italic text-zinc-600" dangerouslySetInnerHTML={{ __html: md(nv.in) }} /> : null}
