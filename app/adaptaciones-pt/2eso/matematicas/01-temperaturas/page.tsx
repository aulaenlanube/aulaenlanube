...
export default function Movido() {
  ...
  useEffect(() => {
    router.replace("/adaptaciones-pt/2eso/matematicas/tema-1/02-recta/");
  }, [router]);
  return (
    <div className="mx-auto w-full max-w-4xl px-4 py-16 text-center">
      ...
      <p className="mt-3 text-zinc-600 dark:text-zinc-400">
        ...
        <a className="font-semibold text-blue-700 dark:text-blue-300 underline" href="/adaptaciones-pt/2eso/matematicas/tema-1/02-recta/">mira el apartado completo aquí</a>.
      </p>
    </div>
  );
}
